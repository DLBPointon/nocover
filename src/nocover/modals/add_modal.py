...
class AddModal(ModalScreen):
    ...
    def split_data(self, data: dict[str, str], search_attribute: str):
    ...
    def parse_data(self, query: str):
        ...
        if isinstance(raw_data, bool):
            self.app.push_screen(ErrorModal("NO DATA!"))
    ...
    def sort_books(self, book_list):
        return sorted(book_list, key=lambda x: x.series_position, reverse=False)
